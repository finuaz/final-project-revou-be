...
Revision ID: 4e77bbff4351
Revises: 
Create Date: 2024-05-04 18:34:53.948914
...
def upgrade():
    ...
    sa.Column('calories_per_gram', sa.DECIMAL(precision=10, scale=2), nullable=True),
    sa.Column('fat_per_gram', sa.DECIMAL(precision=10, scale=2), nullable=True),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
